      ...
      <form action="" @submit.prevent="handleSubmit(UpdateBill(Bill))">
        ...
        <div class="form-group">
          <label for="">Tên Khách hàng</label>
            ...
            name="Hình ảnh  "
          >
          <input v-model="Bill.customer" type="text" class="form-control"  readonly/>
          ...
          <label for="">Số điện thoại</label>
            ...
            name="Hình ảnh  "
          >
          <input v-model="Bill.phonenumber" type="text" class="form-control" readonly/>
          <p class="muted text-danger">
              {{ errors[0] }}
            </p>
          </ValidationProvider>
          ...
          <div class="form-group">
           <label for="">Địa chỉ</label>
            ...
            name="Hình ảnh  "
          >
          <input v-model="Bill.address" type="text" class="form-control" readonly/>
          <p class="muted text-danger">
              {{ errors[0] }}
            </p>
          </ValidationProvider>
