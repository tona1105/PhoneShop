    ...
    <b-card no-body>
      <b-nav pills card-header slot="header" v-b-scrollspy:nav-scroller>
        <b-nav-item-dropdown text="Quản lý sản phẩm" right-alignment>
          <b-dropdown-item href="/admin/Products/AddProduct" >Thêm sản phẩm</b-dropdown-item>
    ...
    <div class="title">
      ...
      <form action=""  @submit.prevent="UpdateProduct(product)">
        ...
        <div class="form-group">
          ...
          <select v-model="product.menuid"  name="" class="form-control">
        ...
        <div class="form-group">
          <label for="">Hình ảnh</label>
           <ValidationProvider
            ...
            name="Hình ảnh "
          >
          <input v-model="product.imghp" type="text" class="form-control" />
          <p class="muted text-danger">
              {{ errors[0] }}
            </p>
          </ValidationProvider>
        ...
        <div class="form-group">
          <label for="">Hình ảnh 1</label>
           <ValidationProvider
            ...
            name="Hình ảnh 1"
          >
          <input v-model="product.img1" type="text" class="form-control" />
          <p class="muted text-danger">
              {{ errors[0] }}
            </p>
          </ValidationProvider>
       ...
       <div class="form-group">
          <label for="">Hình ảnh 2</label>
           <ValidationProvider
            ...
            name="Hình ảnh 2 "
          >
          <input v-model="product.img2" type="text" class="form-control" />
          <p class="muted text-danger">
              {{ errors[0] }}
            </p>
          </ValidationProvider>
       ...
       <div class="form-group">
          <label for="">Hình ảnh 3</label>
            ...
            name="Hình ảnh 3 "
          >
          <input v-model="product.img3" type="text" class="form-control" />
          <p class="muted text-danger">
              {{ errors[0] }}
            </p>
          </ValidationProvider>
        ...
        <div class="form-group">
          <label for="">Hình ảnh 4</label>
            ...
            name="Hình ảnh 4 "
          >
          <input v-model="product.img4" type="text" class="form-control" />
          <p class="muted text-danger">
              {{ errors[0] }}
            </p>
          </ValidationProvider>
        ...
        <div class="form-group">
          ...
          <input v-model="product.inStock"  class="form-control">
        </div>
        <div class="form-group">
          <label for="">Loại</label>
          <select v-model="product.typeProduct"  class="form-control">
