      ...
      <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
          <div class="flex-fill">
              <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="/about"><b>Giới thiệu</b></a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="/order"><b>Đơn Hàng</b></a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="/Contact"><b>Liên hệ</b></a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="navbar align-self-center d-flex" style="padding-right:80px; border: 1px solid #333;">
...
body, ul, li, p, a, label, input, div {
  ...
  */
  ...
  .navbar{
    background: linear-gradient(to left, #3fff9d, #70dce7) !important;
  }
  .container{
