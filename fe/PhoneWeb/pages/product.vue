...
<div class="row">
    ...
    <!-- Product Item -->
    <div v-for="(listproduct,index) in listproduct" :key="index"
     class="product-grid col-xs-12 col-sm-6 col-md-3">
      <div class="product-item">
        <div class="sale-tag">
          <span>SALE</span>
        </div>
        <div class="image">
          <a href=""><img :src="listproduct.productimghp" alt=""></a>
        </div>
        <div class="caption">
          ...
          <div class="price">
            <span class="price-new">{{ listproduct.productprice }}</span>
          </div>
          <div class="cart">
